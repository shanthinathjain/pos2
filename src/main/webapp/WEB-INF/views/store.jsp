...
<body>
	...
	<form:form action="store.html" method="post">
		...
		<tbody>
			...
			<c:forEach items="${STORELIST}" var="s">
				...
				<td><c:out value="${s.id}"></c:out></td>
					...
					<td><a href="<c:url value='/store-edit-${s.storeId}'/>"><button>Modify/View</button></a></td>					
				 <td><a href="<c:url value='/store-search-${s.storeId}'/>"><button>View</button></a></td>
